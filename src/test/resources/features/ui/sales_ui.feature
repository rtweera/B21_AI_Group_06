...
Feature: Sales UI Tests
  ...
  # -----------------------------------------------------------------------
  # Admin – Sell plant (UI: /ui/sales/new)
  # -----------------------------------------------------------------------
  ...
  # -----------------------------------------------------------------------
  # Admin – Default sort by date descending (UI: /ui/sales)
  # -----------------------------------------------------------------------
  ...
  # -----------------------------------------------------------------------
  # Admin – Cancel sell plant (UI: /ui/sales/new)
  # -----------------------------------------------------------------------
  ...
  # -----------------------------------------------------------------------
  # Unauthenticated access – Sales page (UI: /ui/sales)
  # -----------------------------------------------------------------------
