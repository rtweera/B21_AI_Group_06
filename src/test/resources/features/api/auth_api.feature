...
Feature: Authentication API Tests
  ...
  # -----------------------------------------------------------------------
  # 215527A – Login endpoints
  # -----------------------------------------------------------------------

  @API_POST_AUTH_ADM_001 @215527A
  ...
  # -----------------------------------------------------------------------
  # 215552U – Unauthenticated access to protected endpoints
  # -----------------------------------------------------------------------

  @API_GET_AUTH_USR_001 @215552U
