...
public class SalesUiSteps {
    ...
    public void iAmLoggedInAsAdmin() {
        ...
        salesPage.goToLogin();
        salesPage.login("admin", "admin123");
    ...
    // Matches: "And a plant is available with stock greater than 0"
    ...
    public void aPlantIsAvailable() {
        ...
        salesPage.goToPlantsPage();
        assertTrue(salesPage.getPlantsRowCount() > 0, "Plants should exist");
        System.out.println("[PASS] Plants exist");
    }

    // Matches: "When I navigate to the Sell Plant page"
    ...
    public void iNavigateToSellPlantPage() {
        ...
        salesPage.goToSellPlantPage();
        System.out.println("[PASS] On Sell Plant page");
    }

    // Matches: "And I select the first plant from the dropdown"
    ...
    public void iShouldSeeQuantityError() {
        ...
        assertTrue(salesPage.isQuantityErrorVisible(),
    ...
    public void theSaleShouldBeRemoved() {
        System.out.println("[STEP] Verifying the sale was removed / list refreshed...");
    ...
    public void atLeastTwoSalesExist() {
        ...
        salesPage.goToSalesListPage();
        // Keep creating sales until we have at least 2
    ...
    public void mostRecentSaleFirst() {
        ...
        assertTrue(firstDate.compareTo(secondDate) >= 0,
                "Row 1 date should be newer than or equal to Row 2. Row1=" + firstDate + " Row2=" + secondDate);
    ...
    public void iShouldBeRedirectedToLoginPage() {
        ...
        assertTrue(salesPage.isOnLoginPage(),
                "Should be redirected to login. Actual URL: " + salesPage.getCurrentUrl());
        System.out.println("[PASS] Redirected to login page: " + salesPage.getCurrentUrl());
    }
}