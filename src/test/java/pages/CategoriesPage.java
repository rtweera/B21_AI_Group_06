...
public class CategoriesPage extends BasePage {
    ...
    public void clickAddCategory() {
        page.locator("a[href='/ui/categories/add'], a:has-text('Add A Category')").first().click();
    }
    ...
    public void verifyCategoryVisible(String categoryName) {
        assertThat(page.locator("table tbody tr")
    ...
    public void verifyCategoryNameEntered(String expectedName) {
        ...
        Assert.assertEquals(actualValue, expectedName,
                "Expected category name: " + expectedName + " but found: " + actualValue);
    }
    ...
    public void verifyNoCategoryFoundMessage(String expectedMessage) {
        assertThat(page.locator("td:has-text('" + expectedMessage + "'), body:has-text('" + expectedMessage + "')").first()).isVisible();
    }
    ...
    public void assertOnlyRowsContaining(String name) {
        ...
        for (Locator row : rows) {
            ...
            Assert.assertTrue(rowName.contains(expected),
                    "Expected row name to contain '" + name + "', but was: " + rowName);
        }
    }
    ...
    private int visibleCount(String selector) {
        ...
        for (int index = 0; index < locator.count(); index++) {
            if (locator.nth(index).isVisible()) visible++;
        }
        return visible;
    }
}
